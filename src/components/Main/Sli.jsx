...
const Sli = () => {
  ...
  return (
    <div className="min-h-screen flex  flex-col-reverse bg-cover bg-center bg-no-repeat lg:flex-row pt-20 lg:pt-40 justify-center px-6 lg:px-20 "
  ...
  <div className="grid grid-cols-1 pt-20 sm:grid-cols-3 gap-4 sm:gap-6">
    <div className="bg-gray-900 border border-blue-500 rounded-xl hover:scale-105 transition-transform duration-300 text-center">
     <img className=" object-cover object-center rounded-xl" src="./src/assets/images/Sli1.gif" alt="" />
    </div>
    <div className="bg-gray-900 border border-blue-500 rounded-xl hover:scale-105 transition-transform duration-300 text-center">
     <img className=" object-cover object-center rounded-xl" src="./src/assets/images/Sli2.gif" alt="" />
    </div>
    <div className="bg-gray-900 border border-blue-500 rounded-xl hover:scale-105 transition-transform duration-300 text-center">
     <img className=" object-cover object-center rounded-xl" src="./src/assets/images/Sli3.gif" alt="" />
    </div>
  ...
  <div className="relative w-full h-full  rounded-full overflow-hidden border-2 lg:border-5 border-blue-500">
    <img
      src="./src/assets/images/About.gif" // replace with your image path
      alt="Meas"
